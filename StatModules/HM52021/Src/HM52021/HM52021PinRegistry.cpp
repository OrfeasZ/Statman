...
std::unordered_map<int32_t, std::string> HM52021PinHandler::m_PinRegistry
{
	{ -740712821, "A" },
	...
	{ 946268862, "CC_Miss" },
	{ 1938189634, "CC_Miss_Human_Shield" },
	...
	{ 2133451414, "Duration" },
	{ 1121532308, "E_TimeToEndEvent1" },
	{ -607098834, "E_TimeToEndEvent2" },
	{ -1395173192, "E_TimeToEndEvent3" },
	{ 850644251, "E_TimeToEndEvent4" },
	...
	{ -1725454783, "Failed" },
	{ -262309861, "FemalePush" },
	{ 1605397818, "FemalePushSignal" },
	...
	{ -1122520576, "HasAnyItemEquipt" },
	{ 1233015991, "HasWeaponEquipt" },
	...
	{ -296215282, "Hue" },
	{ -713719671, "HumanShield" },
	{ -1736265789, "HumanShieldDead" },
	{ -508665111, "HumanShieldExit" },
	{ -587065671, "I" },
	{ -637307673, "IActor" },
	{ 1213240230, "IdleEnd" },
	...
	{ 569188712, "NPCAlertedPos" },
	{ 659581906, "NPCAllShots" },
	{ -1485185225, "NPCAmbient" },
	{ -1228323914, "NPCAmbientPos" },
	{ 716918858, "NPCCivilianAlerted" },
	{ 596746016, "NPCCivilianAlertedPos" },
	{ -1125966295, "NPCCivilianScared" },
	{ 1649037698, "NPCCivilianScaredPos" },
	{ -153697742, "NPCDead" },
	{ 151475049, "NPCDeadPos" },
	...
	{ 1783155809, "OnBoxBoundsChanged" },
	{ 41160331, "OnBoxVolumeChanged" },
	{ 450048113, "OnBroken" },
	{ 656542102, "OnBusy" },
	...
	{ 343750416, "OnCoreLost" },
	{ 617848973, "OnCoreSleep" },
	{ 1901097519, "OnCoreWake" },
	...
	{ -611360625, "OnProgressActive" },
	{ 88896575, "OnProgressFalse" },
	{ -62413032, "OnProgressInactive" },
	{ -281209218, "OnProgressSelected" },
	{ -923942160, "OnProgressTrue" },
	{ -374400226, "OnProgressUnselected" },
	{ -1224892120, "OnPressedIActor" },
	{ -318768411, "OnProjectionTurnedOff" },
	{ -1648804941, "OnProjectionTurnedOn" },
	{ -1605220874, "OnPromote" },
	...
	{ -316504076, "SetValue" },
	{ -1003366810, "ShootingBalletKillTagged" },
	{ 1056173252, "ShotBegin" },
	{ 1396300407, "ShotEnd" },
	{ -685231563, "ShotFired" },
	{ -872576211, "ShotFiredAtPos" },
	...
	{ -1662558712, "SomeoneDiedAtPos" },
	{ 404568849, "SomeonePacified" },
	{ -327769703, "SomeonePacifiedAtPos" },
	{ 8062158, "SomeoneScared" },
	{ -2116383187, "SomeoneScaredAtPos" },
	...
	{ -1076903622, "SoundTensionDownToOrange" },
	{ 1913560285, "SoundTensionDownToYellow" },
	{ 284102352, "SoundTensionUpToOrange" },
	{ 2128510228, "SoundTensionUpToRed" },
	{ -584166601, "SoundTensionUpToYellow" },
	...
	{ 1204857385, "StanddownFailed" },
	{ -485820344, "StanddownSuccess" },
	{ 1589148299, "Start" },
	...
	{ 337250058, "Tag_TimeToEndEvent1" },
	{ -1928112464, "Tag_TimeToEndEvent2" },
	{ -99326426, "Tag_TimeToEndEvent3" },
	{ 1685123973, "Tag_TimeToEndEvent4" },
	{ -339413771, "TakeDamage" },
	{ -1599236937, "TakeHealthPack" },
	{ 635282281, "TakeHumanShield" },
	{ -1641100752, "TakeOutNonLethal" },
	{ -1096731074, "TakedownAvailable" },
	{ 1603816054, "TakedownBegin" },
	{ 173540471, "TakedownEnd" },
	{ 1902794112, "TakedownUnavailable" },
	{ 1627761601, "TakingNewDisguise" },
	{ 1646838764, "TargetAccidentKill" },
	{ -314056027, "TargetDied" },
	{ 213230084, "TargetKilled" },
	{ 760288075, "TargetLost" },
