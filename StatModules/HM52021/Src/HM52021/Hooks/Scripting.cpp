...
#include <HM52021/HM52021PinHandler.h>
#include <HM52021/Structs/ZResourceID.h>
...
DECLARE_FASTCALL_DETOUR(HM52021Hooks, void, SignalOutputPin, ZEntityType** entity, int32_t pin, ZVariantRef* data)
{
...
DECLARE_FASTCALL_DETOUR(HM52021Hooks, ZRuntimeResourceID*, ZRuntimeResourceID_QueryRuntimeResourceID, ZRuntimeResourceID* th, ZResourceID* resourceId)
{
...
DECLARE_FASTCALL_DETOUR(HM52021Hooks, void, ZAchievementManagerSimple_OnEventSent, ZAchievementManagerSimple* th, uint32_t eventIndex, ZDynamicObject* event)
{
	ZString s_EventStr;
...
DECLARE_FASTCALL_DETOUR(HM52021Hooks, void, ZChallengesManager_OnEventSent, ZChallengesManager* th, uint32_t eventIndex, ZDynamicObject* event)
{
	ZString s_EventStr;
	event->ToString(event, &s_EventStr);
...
DECLARE_FASTCALL_DETOUR(HM52021Hooks, void, ZContractsManager_OnEventSent, ZContractsManager* th, uint32_t eventIndex, ZDynamicObject* event)
{
	ZString s_EventStr;
	event->ToString(event, &s_EventStr);
