...
namespace Statman.Engines
{
    class HM3Engine : IEngine
    {
            ...
            <string, Tuple<string, string, bool>>()
        {
            ...
            { "scenes\\saveandcontinue.gms", new Tuple<string, string, bool>("Save & Continue", "Menu", false) },
            ...
            { "scenes\\m01\\m01_premission.gms", new Tuple<string, string, bool>("A Vintage Year", "Pre-Mission", false) },
            ...
            { "scenes\\m01\\m01_postmission.gms", new Tuple<string, string, bool>("A Vintage Year", "Post-Mission", false) },
            { "m01\\m01_news", new Tuple<string, string, bool>("A Vintage Year", "News", false) },
            { "scenes\\m01\\m01_news.gms", new Tuple<string, string, bool>("A Vintage Year", "News", false) },

            { "m03\\m03_premission", new Tuple<string, string, bool>("Curtains Down", "Pre-Mission", false) },
            { "scenes\\m03\\m03_premission.gms", new Tuple<string, string, bool>("Curtains Down", "Pre-Mission", false) },
            ...
            { "scenes\\m03\\m03_postmission.gms", new Tuple<string, string, bool>("Curtains Down", "Post-Mission", false) },
            { "m03\\m03_news", new Tuple<string, string, bool>("Curtains Down", "News", false) },
            { "scenes\\m03\\m03_news.gms", new Tuple<string, string, bool>("Curtains Down", "News", false) },

            { "m04\\m04_premission", new Tuple<string, string, bool>("Flatline", "Pre-Mission", false) },
            { "scenes\\m04\\m04_premission.gms", new Tuple<string, string, bool>("Flatline", "Pre-Mission", false) },
            ...
            { "scenes\\m04\\m04_postmission.gms", new Tuple<string, string, bool>("Flatline", "Post-Mission", false) },
            { "m04\\m04_news", new Tuple<string, string, bool>("Flatline", "News", false) },
            { "scenes\\m04\\m04_news.gms", new Tuple<string, string, bool>("Flatline", "News", false) },

            { "m05\\m05_premission", new Tuple<string, string, bool>("A New Life", "Pre-Mission", false) },
            { "scenes\\m05\\m05_premission.gms", new Tuple<string, string, bool>("A New Life", "Pre-Mission", false) },
            ...
            { "scenes\\m05\\m05_postmission.gms", new Tuple<string, string, bool>("A New Life", "Post-Mission", false) },
            { "m05\\m05_news", new Tuple<string, string, bool>("A New Life", "News", false) },
            { "scenes\\m05\\m05_news.gms", new Tuple<string, string, bool>("A New Life", "News", false) },

            { "m06\\m06_premission", new Tuple<string, string, bool>("Murder of the Crows", "Pre-Mission", false) },
            { "scenes\\m06\\m06_premission.gms", new Tuple<string, string, bool>("Murder of the Crows", "Pre-Mission", false) },
            ...
            { "scenes\\m06\\m06_postmission.gms", new Tuple<string, string, bool>("Murder of the Crows", "Post-Mission", false) },
            { "m06\\m06_news", new Tuple<string, string, bool>("Murder of the Crows", "News", false) },
            { "scenes\\m06\\m06_news.gms", new Tuple<string, string, bool>("Murder of the Crows", "News", false) },
            ...
            { "scenes\\m02\\m02_postmission.gms", new Tuple<string, string, bool>("You Better Watch Out", "Post-Mission", false) },
            { "m02\\m02_news", new Tuple<string, string, bool>("You Better Watch Out", "News", false) },
            { "scenes\\m02\\m02_news.gms", new Tuple<string, string, bool>("You Better Watch Out", "News", false) },

            { "m08\\m08_premission", new Tuple<string, string, bool>("Death on the Mississippi", "Pre-Mission", false) },
            { "scenes\\m08\\m08_premission.gms", new Tuple<string, string, bool>("Death on the Mississippi", "Pre-Mission", false) },
            ...
            { "scenes\\m08\\m08_postmission.gms", new Tuple<string, string, bool>("Death on the Mississippi", "Post-Mission", false) },
            { "m08\\m08_news", new Tuple<string, string, bool>("Death on the Mississippi", "News", false) },
            { "scenes\\m08\\m08_news.gms", new Tuple<string, string, bool>("Death on the Mississippi", "News", false) },

            { "m09\\m09_premission", new Tuple<string, string, bool>("Till Death Do Us Part", "Pre-Mission", false) },
            { "scenes\\m09\\m09_premission.gms", new Tuple<string, string, bool>("Till Death Do Us Part", "Pre-Mission", false) },
            ...
            { "scenes\\m09\\m09_postmission.gms", new Tuple<string, string, bool>("Till Death Do Us Part", "Post-Mission", false) },
            { "m09\\m09_news", new Tuple<string, string, bool>("Till Death Do Us Part", "News", false) },
            { "scenes\\m09\\m09_news.gms", new Tuple<string, string, bool>("Till Death Do Us Part", "News", false) },

            { "m10\\m10_premission", new Tuple<string, string, bool>("A House of Cards", "Pre-Mission", false) },
            { "scenes\\m10\\m10_premission.gms", new Tuple<string, string, bool>("A House of Cards", "Pre-Mission", false) },
            ...
            { "scenes\\m10\\m10_postmission.gms", new Tuple<string, string, bool>("A House of Cards", "Post-Mission", false) },
            { "m10\\m10_news", new Tuple<string, string, bool>("A House of Cards", "News", false) },
            { "scenes\\m10\\m10_news.gms", new Tuple<string, string, bool>("A House of Cards", "News", false) },

            { "m11\\m11_premission", new Tuple<string, string, bool>("A Dance with The Devil", "Pre-Mission", false) },
            { "scenes\\m11\\m11_premission.gms", new Tuple<string, string, bool>("A Dance with The Devil", "Pre-Mission", false) },
            ...
            { "scenes\\m11\\m11_postmission.gms", new Tuple<string, string, bool>("A Dance with The Devil", "Post-Mission", false) },
            { "m11\\m11_news", new Tuple<string, string, bool>("A Dance with The Devil", "News", false) },
            { "scenes\\m11\\m11_news.gms", new Tuple<string, string, bool>("A Dance with The Devil", "News", false) },

            { "m12\\m12_premission", new Tuple<string, string, bool>("Amendment XXV", "Pre-Mission", false) },
            { "scenes\\m12\\m12_premission.gms", new Tuple<string, string, bool>("Amendment XXV", "Pre-Mission", false) },
            ...
            { "scenes\\m12\\m12_postmission.gms", new Tuple<string, string, bool>("Amendment XXV", "Post-Mission", false) },
            { "m12\\m12_news", new Tuple<string, string, bool>("Amendment XXV", "News", false) },
            { "scenes\\m12\\m12_news.gms", new Tuple<string, string, bool>("Amendment XXV", "News", false) },
